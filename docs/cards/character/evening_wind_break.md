...
<img src="/images/cards/evening_wind_break.png" alt="晚风断" style="max-width:300px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.15)" />
...
- **伤害换属性的透支型设计**：1 费造成 20 点伤害，代价是全属性各 -1。每次打出都永久削弱自身——[力量](/powers/strength_power.md)降低减少后续伤害，[防御](/powers/defense_power.md)降低减少格挡获取，[命中](/powers/accuracy_power.md)降低影响暴击率，[速度](/powers/speed_power.md)降低影响行动顺序。5 PP 打完后全属性 -5，是一个严重的累积惩罚。
...
- [力量](/powers/strength_power.md)（受到 -1 影响的物理伤害属性）
- [防御](/powers/defense_power.md)（受到 -1 影响的格挡属性）
- [命中](/powers/accuracy_power.md)（受到 -1 影响的暴击属性）
- [速度](/powers/speed_power.md)（受到 -1 影响的速度属性）

## 相关机制

- [PP系统](/mechanics/pp-system.md)（PP 消耗）
- [四维属性](/mechanics/attributes.md)（属性增减机制）
- [属性惩罚](/mechanics/attributes.md#属性下降)（累积全属性下降的影响）
